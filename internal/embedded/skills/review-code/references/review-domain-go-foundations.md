...
| No unnecessary comments | Code should be self-documenting; no comments that restate the code | Grep for comment patterns that restate function names or obvious logic |
